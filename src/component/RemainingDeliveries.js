...
export default class RemainingDeliveries extends Component {
  render() {
    var left = (
      <Left style={{flex:1}}>
    ...
    return(
      <SideMenuDrawer ref={(ref) => this._sideMenuDrawer = ref}>
          <Container>
            <Navbar left={left} right={right} title="Remaining" color = "white"/>
            <Content>
              {this.renderpin()}
            </Content>
          </Container>
  ...
  renderpin() {
    return (
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center" ,marginTop:250 }}>
        <Text>There's nothing you have to deliver.</Text>
      </View>
    );
  }
}
