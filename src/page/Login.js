...
export default class Login extends Component {
  ...
  render() {
    ...
    var right = (
      <Right style={{flex:1}}>
        ...
        <Button onPress={() => Actions.app()} transparent>
          <Icon name='ios-cart' />
        </Button>
      </Right>
    );
      ...
      <Container style={{backgroundColor: '#fdfdfd'}}>
        ...
        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center', paddingLeft: 50, paddingRight: 50}}>
          ...
          <View style={{alignItems: 'center'}}>
            <Button onPress={() =>Actions.app()} style={{backgroundColor: Colors.navbarBackgroundColor, marginTop: 20}}>
  ...
  login() {
      ...
      if(this.state.username!='Kaustubh' && this.state.password!="123456")
